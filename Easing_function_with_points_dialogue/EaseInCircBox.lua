-- Calculate easeInCirc
local function easeInCirc(t)
  return 1 - math.sqrt(1 - t * t)
end

-- Main script
local retval, num_points = reaper.GetUserInputs("EaseInCirc", 1, "Number of points:", "100")
...
if retval then
  ...
  if num_points then
    ...
    if envelope then
      ...
      reaper.Undo_EndBlock("Apply easeInCirc to selected envelope", -1)
    else
