-- Calculate easeInQuint
local function easeInQuint(t)
  return t * t * t * t * t
end

-- Main script
local retval, num_points = reaper.GetUserInputs("EaseInQuint", 1, "Number of points:", "100")
...
if retval then
  ...
  if num_points then
    ...
    if envelope then
      ...
      reaper.Undo_EndBlock("Apply easeInQuint to selected envelope", -1)
    else
