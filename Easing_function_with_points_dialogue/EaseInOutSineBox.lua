-- Calculate easeInOutSine
local function easeInOutSine(t)
    return -0.5 * (math.cos(math.pi * t) - 1)
end

-- Main script
local retval, num_points = reaper.GetUserInputs("EaseInOutSine", 1, "Number of points:", "100")
...
if retval then
    ...
    if num_points then
        ...
        if envelope then
            ...
            reaper.Undo_EndBlock("Apply easeInOutSine to selected envelope", -1)
        else
