...
-- Main script
local retval, num_points = reaper.GetUserInputs("EaseInSine", 1, "Number of points:", "100")
...
if retval then
  ...
  if num_points then
    ...
    if envelope then
      ...
      reaper.Undo_EndBlock("Apply easeInSine to selected envelope", -1)
    else
