...
function EaseInBack(t)
    local s = 1.70158
    return 0.9 * (t * t * ((s + 1) * t - s)) + 0.1
end

local retval, num_points = reaper.GetUserInputs("Ease In Back", 1, "Number of points:", "100")
...
if retval then
    ...
    if envelope and time_range > 0 then
        ...
        for i = 0, num_points do
            ...
            local eased_value = EaseInBack(t) * scale
        ...
        reaper.Undo_EndBlock("Ease In Back Envelope Points", -1)
    end
end
