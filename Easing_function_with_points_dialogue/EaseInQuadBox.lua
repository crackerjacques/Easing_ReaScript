...
local retval, num_points = reaper.GetUserInputs("Ease In Quad", 1, "Number of points:", "100")
...
if retval then
    ...
    if envelope and time_range > 0 then
        ...
        for i = 0, num_points do
            ...
            local eased_value = easeInQuad(t) * scale
        ...
        reaper.Undo_EndBlock("Ease In Quad Envelope Points", -1)
    end
end
