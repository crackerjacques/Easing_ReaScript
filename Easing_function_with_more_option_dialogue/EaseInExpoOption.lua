...
local retval, userInput = reaper.GetUserInputs("EaseInExpo", 3, "Number of points,Lower limit,Upper limit", "100,0.2,0.8")
...
if retval then
    ...
    if num_points and lower_limit and upper_limit then
        ...
        if env then
            ...
            reaper.Undo_EndBlock("Create EaseInExpo Envelope Points", -1)
        end
    else
